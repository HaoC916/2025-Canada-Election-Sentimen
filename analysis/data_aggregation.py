...
# -------------------------------------------------------------
# Important Notes:
#    Need to manually download the dataset of scored comments 
#    from https://drive.google.com/file/d/1bXJ_JlQu_xzUsRbajEGasY8UCPJ51-57/view?usp=drive_link
#    and extract into data/ folder before running this script.
     
#  Or the dataset could also be generated by running the
#  Step 3 sentiment scoring scripts (read README for details).
# ------------------------------------------------------------- 
df = spark.read.json("data/vader_tran_scored_updated_key/part-*.json")
